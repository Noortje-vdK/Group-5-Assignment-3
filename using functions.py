...
random_forest = RandomForestClassifier(n_estimators=411, criterion='gini', max_depth=None, min_samples_split=10, min_samples_leaf=1, max_features='auto', random_state=42, class_weight = "balanced")
